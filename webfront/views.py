...
@cache_page(5*60)
@render('webfront/index.html')
def home(request):
    return {}

@cache_page(60*60)
@render('webfront/map_list.html')
def maps(request):
    maps = Map.objects.all()
    return {'maps': maps}

@cache_page(60*60)
@render('webfront/ban_list.html')
@flood
def banlist(request):
...
@login_required
@cache_page(120*60)
@render('webfront/world_map_banned.html')
@flood
...
@cache_page(30*60)
@render('webfront/kick_list.html')
...
@permission_required_with_403('b3connect.view_penalty')
@cache_page(30*60)
@render('webfront/penalty_list.html')
...
@cache_page(30*60)
@render('webfront/notice_list.html')
